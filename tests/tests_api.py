...
class Test_API:
    ...
    def test_create_task(self):
        ...
        assert create_task_response.status_code == 200, "Status code not as expected."

        data = create_task_response.json()

        task_id = data["task"]["task_id"]
        get_task_response = get_task(self, task_id, URL)
        assert get_task_response.status_code == 200, "Status code not as expected."
    ...
    def test_update_task(self):
        ...
        assert update_task_response.status_code == 200, "Status code not as expected."
        get_task_response = get_task(self, task_id, URL)
        assert get_task_response.status_code == 200, "Status code not as expected."
        get_task_data = get_task_response.json()
    ...
    def test_list_tasks(self):
        ...
        assert list_task_response.status_code == 200, "Status code not as expected."
    ...
    def test_delete_task(self):
        ...
        assert delete_task_response.status_code == 200, "Status code not as expected."
        get_task_response = get_task(self, task_id, URL)
        assert get_task_response.status_code == 404, "Status code not as expected."
